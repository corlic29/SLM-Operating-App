...
function varargout = App_Zernike(varargin)
% APP_ZERNIKE MATLAB code for App_Zernike.fig
%      APP_ZERNIKE, by itself, creates a new APP_ZERNIKE or raises the existing
%      singleton*.
%
%      H = APP_ZERNIKE returns the handle to a new APP_ZERNIKE or the handle to
%      the existing singleton*.
%
%      APP_ZERNIKE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in APP_ZERNIKE.M with the given input arguments.
%
%      APP_ZERNIKE('Property','Value',...) creates a new APP_ZERNIKE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before App_Zernike_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to App_Zernike_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help App_Zernike

% Last Modified by GUIDE v2.5 22-Jan-2019 15:10:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @App_Zernike_OpeningFcn, ...
                   'gui_OutputFcn',  @App_Zernike_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before App_Zernike is made visible.
function App_Zernike_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to App_Zernike (see VARARGIN)

% Choose default command line output for App_Zernike
handles.output = hObject;


guidata(hObject, handles);

% UIWAIT makes App_Zernike wait for user response (see UIRESUME)
% uiwait(handles.figure1);

end

% --- Outputs from this function are returned to the command line.
function varargout = App_Zernike_OutputFcn(hObject, eventdata, handles) 
